package br.com.benefrancis.ordenando;
...
public class Main {
	...
	public static void main(String[] args) {
		...
		persons.add(new Person("Airton", 29, 1500.50));
 		...
 		System.out.println("Ordenação por nomes ascendente");
 		testSortForNameAsc(persons);
 		
 		System.out.println("Ordenação por nomes decresente");
 		testSortForNameDesc(persons);
 		
 		System.out.println("Ordenação por idade ascendente");
 		testSortForAgeAsc(persons);
 		
 		System.out.println("Ordenando por salário");
 		testSortForSalaryAsc(persons);
		
 		System.out.println("Exibindo apenas salários");
 		showOnlySalary(persons);
 		
 		System.out.println("Exibindo apenas salários maiories que 3000");
 		showOnlySalaryHigherThan(persons, 3000d);
 		
 		System.out.println("Exibindo a soma dos salários de funcionarios com mais de 30 anos");
	...
	System.out.printf("A soma dos salários é: %.2f", total);
	}
