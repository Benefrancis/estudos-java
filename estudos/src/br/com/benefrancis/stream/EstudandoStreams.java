...
public class EstudandoStreams {
	public static void main(String[] args) {
		...
		Stream<String> s2 = Stream.of("Maria", "José", "Alex", "Benefrancis", "Edilaine", "Bruno", "Erick",
				"Davi Lucca");

		System.out.println(Arrays.toString(s2.toArray()));

		Stream<Integer> s3 = Stream.iterate(0, x -> x + 2);
		System.out.println("SOMA 2 A CADA NÚMERO: " + Arrays.toString(s3.limit(100).toArray()));
		...
		// Somatório da lista
		// A função reduce recebe como parâmetros:
		// a) o Elemento neutro do que se deseja fazer; no caso da soma, o zero (se
		// fosse multiplicação seria o 1);
		// b) como segundo parâmetro a função para fazer o que se deseja: Neste caso,
